//package java.p02;
//
//import junit.main.java.p02.Account;
//import org.junit.*;
...
//        // boolean에 대한 assertion은 assertTrue, assertFalse를 쓰면 좋음
//        // assertFalse(actualResult);
//        assertThat(actualResult, is(equalTo(true))); // 3. Assert
//        assertThat(actualResult, not(equalTo(false))); // is <-> not
//        // 단, 실패했을때 정보를 잘 표현하기 위해서는
//        // hamcrest의 CoreMatcher에 구현된 matcher를 쓰는것이 좋다.
//    }
//
//    @Test
//    public void answerIsNotMinusWithPostiveBalance() {
//        account.withdraw(50);
//        boolean actualResult = account.isMinus();
//
...
//
//    @Test
//    @Ignore("THis will be tested later.") // 이것을 남겨두고 commit 금지
//    public void checktNegativeBalanceAfterWithdrawal() {
...
//    }
//
//    // Rule을 이용하면 메소드 코드에 expected exception이 드러나므로 인지적으로 개선됨
//    @Rule
